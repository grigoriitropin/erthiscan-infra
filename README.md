...
| :--- | :--- | :--- | :--- |
| **ArgoCD** | `argocd` | `kubectl port-forward svc/argocd-server -n argocd 8080:443` | [https://localhost:8080](https://localhost:8080) |
...
| **Prometheus** | `monitoring` | `kubectl port-forward svc/prometheus-operated -n monitoring 9090:9090` | [http://localhost:9090](http://localhost:9090) |
